...
public class FinalWall extends Tile {

    BufferedImage me;

    public FinalWall(int x, int y, int width, int height, Ids id, Game game, int level) {
    ...
    public void init() {
        this.me = Game.finalwall.getBufferedImage();
    }
}
